...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, main_dir, subset, including):
        ...
        dataset_dir = os.path.join(main_dir, subset)
        annotations_file = os.path.join(main_dir, 'annotations.json')
        # Load annotations
...
def train(model):
    ...
    onlyfiles = [f for f in listdir(os.path.join(args.dataset,'train'))]
    num_to_select = 50
    ...
    dataset_train.load_balloon(args.dataset, "train", train_dataset)
    dataset_train.prepare()

    # Validation dataset
    dataset_val = BalloonDataset()
    dataset_val.load_balloon(args.dataset, "train", val_dataset)
    dataset_val.prepare()
